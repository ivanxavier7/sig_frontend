...
function AddProperty() {
  ...
  function ReducerFuction(draft, action) {
    switch (action.type) {
      ...
      case "catchInternshipCoursesLicenciaturaChange":
        draft.internshipCoursesLicenciaturaValue =
          action.internshipCoursesLicenciaturaChosen;
        break;

      case "catchInternshipCoursesMestradoChange":
        draft.internshipCoursesMestradoValue =
          action.internshipCoursesMestradoChosen;
        break;
      ...
      case "catchProgrammingLangJavaScriptChange":
        draft.programmingLangJavaScriptValue =
          action.programmingLangJavaScriptChosen;
        break;
      ...
      case "catchProgrammingFWFrontEndAngularChange":
        draft.programmingFWFrontEndAngularValue =
          action.programmingFWFrontEndAngularChosen;
        break;

      case "catchProgrammingFWFrontEndjQueryChange":
        draft.programmingFWFrontEndjQueryValue =
          action.programmingFWFrontEndjQueryChosen;
        break;

      case "catchProgrammingFWFrontEndReactChange":
        draft.programmingFWFrontEndReactValue =
          action.programmingFWFrontEndReactChosen;
        break;

      case "catchProgrammingFWFrontEndRubyChange":
        draft.programmingFWFrontEndRubyValue =
          action.programmingFWFrontEndRubyChosen;
        break;

      case "catchProgrammingFWFrontEndVuejsChange":
        draft.programmingFWFrontEndVuejsValue =
          action.programmingFWFrontEndVuejsChosen;
        break;

      case "catchProgrammingFWBackEndASPNetChange":
        draft.programmingFWBackEndASPNetValue =
          action.programmingFWBackEndASPNetChosen;
        break;

      case "catchProgrammingFWBackEndDjangoChange":
        draft.programmingFWBackEndDjangoValue =
          action.programmingFWBackEndDjangoChosen;
        break;

      case "catchProgrammingFWBackEndExpressChange":
        draft.programmingFWBackEndExpressValue =
          action.programmingFWBackEndExpressChosen;
        break;

      case "catchProgrammingFWBackEndLaravelChange":
        draft.programmingFWBackEndLaravelValue =
          action.programmingFWBackEndLaravelChosen;
        break;

      case "catchProgrammingFWBackEndNodejsChange":
        draft.programmingFWBackEndNodejsValue =
          action.programmingFWBackEndNodejsChosen;
        break;

      case "catchProgrammingFWBackEndSpringChange":
        draft.programmingFWBackEndSpringValue =
          action.programmingFWBackEndSpringChosen;
        break;
      ...
      case "catchVacanciesErrors":
        if (
          action.vacanciesChosen.length === 0 ||
          action.vacanciesChosen.value <= 99
        ) {
          draft.vacanciesErrors.hasErrors = true;
          draft.vacanciesErrors.errorMessage =
            "Este campo não deve estar vazio ou passar as 99 vagas";
        }
        break;
    ...
    async function GetProfileInfo() {
      try {
        const response = await Axios.get(
          `https://www.uaestagios.com/api/profiles/${GlobalState.userId}/`
        );
    ...
    if (state.sendRequest) {
      async function AddProperty() {
        ...
        formData.append(
          ...
          state.internshipCoursesCTeSPValue
        );
        formData.append(
          "internship_courses_licenciatura",
          state.internshipCoursesLicenciaturaValue
        );
        formData.append(
          "internship_courses_mestrado",
          state.internshipCoursesMestradoValue
        );
        formData.append(
          "internship_courses_ce",
          state.internshipCoursesCEValue
        );
        formData.append("total_hours", state.totalHoursValue);
        formData.append(
          "programming_lang_python",
          state.programmingLangPythonValue
        );
        formData.append(
          "programming_lang_java",
          state.programmingLangJavaValue
        );
        ...
        formData.append(
          ...
          state.programmingLangJavaScriptValue
        );
        ...
        formData.append(
          ...
          state.programmingLangKotlinValue
        );
        formData.append(
          "programming_lang_matlab",
          state.programmingLangMATLABValue
        );
        formData.append(
          "programming_lang_swift",
          state.programmingLangSwiftValue
        );
        formData.append(
          "programming_lang_rust",
          state.programmingLangRustValue
        );
        formData.append(
          "programming_lang_ruby",
          state.programmingLangRubyValue
        );
        formData.append(
          "programming_lang_dart",
          state.programmingLangDartValue
        );
        formData.append(
          "programming_lang_scala",
          state.programmingLangScalaValue
        );
        formData.append(
          "programming_fw_frontend_angular",
          state.programmingFWFrontEndAngularValue
        );
        formData.append(
          "programming_fw_frontend_jquery",
          state.programmingFWFrontEndjQueryValue
        );
        formData.append(
          "programming_fw_frontend_react",
          state.programmingFWFrontEndReactValue
        );
        formData.append(
          "programming_fw_frontend_ruby",
          state.programmingFWFrontEndRubyValue
        );
        formData.append(
          "programming_fw_frontend_vuejs",
          state.programmingFWFrontEndVuejsValue
        );
        formData.append(
          "programming_fw_backend_aspnet",
          state.programmingFWBackEndASPNetValue
        );
        formData.append(
          "programming_fw_backend_django",
          state.programmingFWBackEndDjangoValue
        );
        formData.append(
          "programming_fw_backend_express",
          state.programmingFWBackEndExpressValue
        );
        formData.append(
          "programming_fw_backend_laravel",
          state.programmingFWBackEndLaravelValue
        );
        formData.append(
          "programming_fw_backend_nodejs",
          state.programmingFWBackEndNodejsValue
        );
        formData.append(
          "programming_fw_backend_spring",
          state.programmingFWBackEndSpringValue
        );
        ...
        try {
          const response = await Axios.post(
            "https://www.uaestagios.com/api/listings/create/",
            formData
          );
  ...
  if (
    ...
    return (
      <div className="custom-body component-box-shadow-no-hover">
        <form onSubmit={FormSubmit}>
          <Grid item container justifyContent="center">
            <Typography variant="h4" className="custom-theme-title">
              Adicionar Proposta de Estágio{" "}
            </Typography>
          </Grid>
          ...
          >
            <Typography variant="h5" className="custom-theme-title">
          ...
          <Grid item style={{ marginTop: "1rem" }}>
            {state.latitudeValue && state.longitudeValue ? (
              <Alert severity="success">
                O seu estagio está localizado nas seguintes coordenadas:{" "}
                {state.latitudeValue}, {state.longitudeValue}
              </Alert>
            ) : (
              <Alert severity="warning">
                Localize o seu estagio no mapa ao arrastar o marcador, antes de

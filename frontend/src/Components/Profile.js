    ...
    if (
      ...
      return (
        <Typography variant="h5" className="welcome-text">
          Bem Vindo{" "}
          <span className="highlight">{GlobalState.userUsername}</span> , por
          favor submete o form para atualizar o perfil.
        </Typography>
      );
    } else {
      return (
        <Box container className="profile-container ">
          <Card sx={{ width: "100%" }}>
            <CardMedia
              sx={{ height: 140 }}
              style={{ height: "20rem" }}
            ...
            />
            <CardContent>
              <Typography variant="h5" className="welcome-text profile-text">
                Bem Vindo{" "}
                <span className="highlight">{GlobalState.userUsername}</span>
              </Typography>
            </CardContent>
          </Card>
        </Box>
